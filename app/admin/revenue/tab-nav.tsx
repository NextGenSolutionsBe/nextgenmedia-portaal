...
const TABS = [
  ...
  // BV-transitie (rechtenbalans, winstverdeling, EZ-raming) staat bewust niet
  // in de tabs: op vraag van de zaakvoerders. De pagina bestaat nog op
  // /admin/revenue/bv-transitie en de data blijft staan.
]
