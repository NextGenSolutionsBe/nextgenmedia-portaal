 ...
 */
export default function InvoicesPage({ searchParams }: { searchParams?: { maand?: string; weergave?: string; categorie?: string } }) {
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      <PlannerClient startCategorie={searchParams?.categorie ?? null} startWeergave={searchParams?.weergave ?? 'lijst'} startDatum={maand} />
    </div>
  )
}
