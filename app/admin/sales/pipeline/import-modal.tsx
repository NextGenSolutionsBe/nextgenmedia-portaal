      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-3xl max-h-[90dvh] flex flex-col overflow-hidden">
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          <div>
            ...
            Upload een lijst; we stellen de kolomkoppeling voor en jij bevestigt. Bedrijven die
            er al in staan komen er niet dubbel bij — die krijgen alleen het label van deze lijst erbij.
          </p>
          </div>
